...
$.ajax({
    ...
    success: function (data) {
        ...
        $.each(data, function (index, content) {
            ...
            console.log("journeyType: " + content.journeyType + " journeyTypeId: " + content.journeyTypeId);
            // console.log("content:" + content);
            // console.log("data:" + JSON.stringify(data));

            let list_html = `<p>
                                <input type="checkbox" class="cboxType" value=${content.journeyTypeId}>
...
$(function () {
    $('form.update-jr').on('submit', function (e) {
        ...
        //             alert(content.journeyId + "," + content.journeyName + "," + content.journeyPrice);
        //             list_count += 1;
        //         });
